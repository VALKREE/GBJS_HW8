...
function handleClick(clickedButtonEvent) {
    ...
    let product = clickedButtonEvent.parentNode;
    ...
    const card = {
        ...
        img: img, // здесь картинка внутри .product
...
function showMoreText(card) {
    ...
    let descText = "Какой-то текст";
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('beforeend', `<div class="desc" style="widht: 150px; height: 150px;">${descText}</div>`)
